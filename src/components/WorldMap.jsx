...
const WorldMap = () => {  // Changed from Map to WorldMap
    ...
    return (
        <section className="py-10 bg-white relative overflow-hidden">
            <div className="mx-auto relative z-10">
                ...
                {/* Map Container */}
                <div className="relative h-auto w-full overflow-hidden max-w-6xl mx-auto">
                    {/* SVG Map Background */}
                    <img src="/mapbase.svg" alt="world map" className="w-full h-auto" />
                    ...
                    {countries.map((country, index) => (
                        ...
                        >
                            <div className="relative group">
                                ...
                                <div className="absolute left-1/2 -translate-x-1/2 mt-2 px-3 py-1 bg-white rounded-full shadow-md text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                                    {country.name}
                                </div>
                            </div>
                        </motion.div>
...
export default WorldMap;  // Changed from Map to WorldMap